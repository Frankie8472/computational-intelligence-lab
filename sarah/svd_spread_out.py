########################################################################################################################
# This is based on the weighted movie mean svd approach                                                                #
# additionally, after loading, the values are multiplied by a factor, to spread them over a larger scale than 1..5     #
# this did not improve the weighted movie mean svd approach                                                            #
########################################################################################################################
...
result_matrix = convert_back(result_matrix)
